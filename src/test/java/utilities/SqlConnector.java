...
public class SqlConnector {
    ...
    private static final String User = ReadConfigFiles.getPropertiesValues("DbUser");
    private static final String Password = ReadConfigFiles.getPropertiesValues("DbPassword");
